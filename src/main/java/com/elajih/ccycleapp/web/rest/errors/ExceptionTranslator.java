package com.elajih.ccycleapp.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(com.elajih.ccycleapp.service.EmailAlreadyUsedException ex, ServerWebExchange request) {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(com.elajih.ccycleapp.service.UsernameAlreadyUsedException ex, ServerWebExchange request) {
        LoginAlreadyUsedException problem = new LoginAlreadyUsedException();
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName,  false, problem.getEntityName(), problem.getErrorKey(), problem.getMessage()));
    }

    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(com.elajih.ccycleapp.service.InvalidPasswordException ex, ServerWebExchange request) {
